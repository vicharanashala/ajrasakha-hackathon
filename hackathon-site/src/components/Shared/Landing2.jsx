  ...
  return (
    <section className="hackathon-schedule">
      <style>{`
        ...
        .glow-1 { top: -10%; left: -10%; background: var(--brand-primary); }
        .glow-2 { bottom: -10%; right: -10%; background: var(--brand-secondary); }
        ...
        .schedule-tab.active {
          ...
          box-shadow: 0 10px 30px oklch(0.7 0.15 160 / 0.35);
        }
      ...
      <div className="schedule-container">
        <header className="schedule-header">
          ...
          <p className="schedule-subtitle">
            Your 48-hour roadmap — from kickoff to final submission.
          </p>
        </header>
